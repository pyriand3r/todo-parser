...
class FileParser {
    ...
    /**
     * @method
     * Override a custom parser method of the line parser instance
     * 
     * @param {string} name The name of the default parser to override 
     * @param {function} method The function to use instead
     */
    override(name, method) {
        this.parser.override(name, method)
    }
}
